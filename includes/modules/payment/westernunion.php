   ...
   function selection() {
     return array('id' => $this->code,
                   ...
                   'icon' => MODULE_PAYMENT_WESTERNUNION_TEXT_CATALOG_LOGO,
				   	'info'=>'<ul>
				            <li>First Name:'.MODULE_PAYMENT_WESTERNUNION_RECEIVER_FIRST_NAME.'</li>'.	
						   '<li>Last Name'.MODULE_PAYMENT_WESTERNUNION_RECEIVER_LAST_NAME.'</li>'.
						   '<li>Phone:'.MODULE_PAYMENT_WESTERNUNION_RECEIVER_PHONE.'</li>'.
						   '<li>Zip:'.MODULE_PAYMENT_WESTERNUNION_RECEIVER_ZIP.'</li>'.
                           '<li>Address:'.MODULE_PAYMENT_WESTERNUNION_RECEIVER_ADDRESS.'</li>'. 
						   '<li>City:'.MODULE_PAYMENT_WESTERNUNION_RECEIVER_CITY.'</li>'.
						   '<li>Country:'.MODULE_PAYMENT_WESTERNUNION_RECEIVER_COUNTRY.'</li>'.	 
                           '</ul>'
                   );
   }
