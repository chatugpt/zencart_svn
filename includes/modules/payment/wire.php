...
function update_status() {
    ...
    function selection() {
      return array('id' => $this->code,
                   'module' => $this->title,
				   	'info'=>'<ul>
				            <li>Name:'.MODULE_PAYMENT_WIRE_NAME.'</li>'.	
						   '<li>Account:'.MODULE_PAYMENT_WIRE_ACCOUNT.'</li>'.
                           '<li>Telephone:'.MODULE_PAYMENT_WIRE_TELEPHONE.'</li>'.
						   '<li>Bank Name:'.MODULE_PAYMENT_WIRE_BANK_NAME.'</li>'.
						   '<li>Bank Address:'.MODULE_PAYMENT_WIRE_BANK_ADDRESS.'</li>'.
						   '<li>Swift Code:'.MODULE_PAYMENT_WIRE_SWIFT_CODE.'</li>'.
                           '</ul>');
    }
